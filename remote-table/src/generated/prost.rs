...
pub mod remote_type {
    ...
    pub enum Type {
        ...
        MongodbDouble(super::Empty),
        #[prost(message, tag = "802")]
        MongodbString(super::Empty),
        #[prost(message, tag = "803")]
        MongodbObject(super::Empty),
        #[prost(message, tag = "804")]
        MongodbArray(super::Empty),
        #[prost(message, tag = "805")]
        MongodbBinary(super::Empty),
        #[prost(message, tag = "806")]
        MongodbObjectId(super::Empty),
        #[prost(message, tag = "807")]
        MongodbBoolean(super::Empty),
        #[prost(message, tag = "808")]
        MongodbDate(super::Empty),
        #[prost(message, tag = "809")]
        MongodbNull(super::Empty),
        #[prost(message, tag = "810")]
        MongodbInt32(super::Empty),
        #[prost(message, tag = "811")]
        MongodbInt64(super::Empty),
        #[prost(message, tag = "812")]
        MongodbDecimal128(super::Empty),
        #[prost(message, tag = "813")]
        MongodbTimestamp(super::Empty),
        #[prost(message, tag = "814")]
        MongodbRegex(super::Empty),
        #[prost(message, tag = "815")]
        MongodbJavascript(super::Empty),
        #[prost(message, tag = "816")]
        MongodbDocument(super::Empty),
    }
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct MdbText {
